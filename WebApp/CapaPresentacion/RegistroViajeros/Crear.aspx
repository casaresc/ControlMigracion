<%@ Page Title="" Language="C#" MasterPageFile="~/CapaPresentacion/Menu.Master" AutoEventWireup="true" CodeBehind="Crear.aspx.cs" Inherits="WebApp.CapaPresentacion.RegistroViajeros.Crear" %>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Datos del Nuevo Viajero</h3>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <div>
                            ...
                            <asp:LinkButton runat="server" PostBackUrl="~/CapaPresentacion/RegistroViajeros/RegistrarViajero" CssClass="btn btn-warning">Volver</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
